...
DEMOS = [
    {
        "number": "01",
        "title": "病院総合トップ",
        "subtitle": "信頼と三朝らしさを、ひとつの玄関に。",
        "summary": "患者さま・ご家族が迷わず目的へ進める情報導線と、温泉・医療・地域を核にしたブランド表現。",
        "features": ["目的別のクイック導線", "重要なお知らせの分類表示", "文字拡大とスマートフォン対応"],
        "value": "病院の第一印象と、情報の探しやすさを同時に改善",
        "color": "#2d7668",
        "tint": "#e4f1eb",
    },
    {
